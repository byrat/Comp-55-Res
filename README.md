1. The goal of this edit is to change the code so that character positioning on the screen can be controlled through a file. This file can be easily edited by people and can be added to if necessary.
